...
from examples.shapenetpart.train_pointwolf_utils import train_one_epoch_pointwolf
...
def main(gpu, cfg):
    ...
    for epoch in range(cfg.start_epoch, cfg.epochs + 1):
        ...
        if cfg.get('pointwolf', None) is not None:
            train_loss = \
                train_one_epoch_pointwolf(model, train_loader, criterion,
